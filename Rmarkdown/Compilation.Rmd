...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    fluidRow(
      column(6, div(tableOutput("shape"),style= "height: 100px; background-color: #fcfcfc;")
      ),
      column(6, div(leafletOutput("SidePlot"), style = "height: 400px; background-color: #fcfcfc;")
      )
    )
  ),  
...
server <- shinyServer(function(input, output, session){
  ...
  output$SidePlot <- renderLeaflet({
    ...
    m <- leaflet() %>%
      ...
      addPolygons(data=UserDAplot, fillOpacity=0.3, smoothFactor=0.5, color= ~pal(Type))
...
shinyApp(ui = ui, server = server)
 ...
 UserDA <- st_read("C:/Users/bcrary/Desktop/Projects/CRB/TestViz/Rmarkdown/UserDAs.shp", quiet=TRUE) 
