...
ui1 <- fluidPage(
  ...
  fluidRow(
    column(width=12,
      plotOutput("donuts"), align ="center", style='padding:0px; height:310px; width:790px; object-fit: none;'
...
donut
    ...
    output$hover_info <- renderUI({
      ...
      point <- nearPoints(data.bd, hover, xvar="xmin", yvar="full", threshold = 5, maxpoints = 1, addDist = TRUE)
